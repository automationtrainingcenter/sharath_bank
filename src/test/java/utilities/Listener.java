...
public class Listener extends GenericHelper implements WebDriverEventListener {
	...
	public void afterChangeValueOf(WebElement arg0, WebDriver arg1, CharSequence[] arg2) {
		...
		test.log(LogStatus.INFO,
				"element value changed to " + js.executeScript("return arguments[0].value", arg0).toString());
	}
	...
	public void afterFindBy(By arg0, WebElement arg1, WebDriver arg2) {
		test.log(LogStatus.INFO, "element located successfully using " + arg0);
	}
...
//		test.log(LogStatus.INFO, "navigated to " + arg0);
	...
	public void beforeAlertAccept(WebDriver arg0) {
		test.log(LogStatus.INFO, "alert came with text as " + arg0.switchTo().alert().getText());
	}
	...
	public void beforeChangeValueOf(WebElement arg0, WebDriver arg1, CharSequence[] arg2) {
		test.log(LogStatus.INFO, "changing element value");
	}
